...
def create_service_preview_tagging():
    ...
    preview_url=response.uri
    print(preview_url)
    container_config=response.template.containers.env[0].value
            ...
            "template": {
                ...
                "containers": [{
                    ...
                    "env": [{
                        ...
                        "value": "https://sst-test-preview-nszpmsl3ca-el.a.run.app",
                    }]
